...
```sh
curl https://mdhs-blog-backend.herokuapp.com/sign-up \
  --include \
  --request POST \
...
```sh
curl https://mdhs-blog-backend.herokuapp.com/sign-in \
  --include \
  --request POST \
  --header "Content-Type: application/json" \
  --data '{
...
```sh
curl --include --request PATCH "https://mdhs-blog-backend.herokuapp.com/change-password" \
...
```sh
curl https://mdhs-blog-backend.herokuapp.com/sign-out \
  --include \
  --request DELETE \
  --header "Authorization: Token token=$TOKEN"
```
...
```sh
curl "https://mdhs-blog-backend.herokuapp.com/blogs" \
  --include \
  --request POST \
  --header "Authorization: Token token=${TOKEN}" \
  --header "Content-Type: application/json" \
...
Request:
```sh
curl "https://mdhs-blog-backend.herokuapp.com/my-blogs" \
  --include \
  --request GET \
  --header "Authorization: Token token=${TOKEN}"
  ```
...
Request:
```sh
curl "https://mdhs-blog-backend.herokuapp.com/blogs/${ID}" \
  --include \
  --request GET \
  ```
...
```sh
curl "https://mdhs-blog-backend.herokuapp.com/comments" \
  --include \
  --request POST \
  --header "Authorization: Token token=${TOKEN}" \
  --header "Content-Type: application/json" \
...
Request:
```sh
curl "https://mdhs-blog-backend.herokuapp.com/my-comments" \
  --include \
  --request GET \
  --header "Authorization: Token token=${TOKEN}"
  ```
...
Request:
```sh
curl "https://mdhs-blog-backend.herokuapp.com/comments/${ID}" \
  --include \
  --request GET \
  ```
